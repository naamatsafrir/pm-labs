# Churn Exit Interview 063

- Artifact Type: Churn Exit Interview
- Segment: North America PMO
- Region: NA
- Participants: Exit Interviewer, Decision Maker, Exit Interviewer
- Source ID: CHURN-EXIT-INTERVIEWS-7063
...
## Evidence Extracts
- Need Signal: API Access for Integrations (Platform Engineer)
  - Quote: "Integration teams need API access for syncing roadmap and planning data."
  - Confidence: high
