# Community Forum Post 056

- Artifact Type: Community Forum Post
- Segment: EMEA Enterprise
- Region: APAC
- Participants: Contributor, Community Moderator, Community Moderator
- Source ID: COMMUNITY-FORUM-POSTS-7056

## Summary
Multiple accounts raised concerns about duplicate item handling during migration. Teams want clearer onboarding milestones for new workspace launches.

## Evidence Extracts
- No explicit top-20 catalog need in this artifact; mostly workflow clarification and onboarding friction.

## Additional Context
Teams want clearer onboarding milestones for new workspace launches. Users want stronger contextual help for first-time configuration steps.
