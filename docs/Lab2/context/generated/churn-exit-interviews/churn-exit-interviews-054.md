# Churn Exit Interview 054

- Artifact Type: Churn Exit Interview
- Segment: Mid-Market
- Region: APAC
- Participants: Decision Maker, Former Admin, Decision Maker
- Source ID: CHURN-EXIT-INTERVIEWS-7054

## Summary
Multiple accounts raised concerns about duplicate item handling during migration. Several users asked for improved in-app glossary and terminology guidance.
