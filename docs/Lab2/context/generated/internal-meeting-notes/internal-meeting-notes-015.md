# Internal Meeting Note 015

- Artifact Type: Internal Meeting Note
- Segment: EMEA Enterprise
- Region: NA
- Participants: Engineering Manager, Engineering Manager, PM
- Source ID: INTERNAL-MEETING-NOTES-7015
...
## Additional Context
Teams want clearer onboarding milestones for new workspace launches. Several users asked for improved in-app glossary and terminology guidance.
