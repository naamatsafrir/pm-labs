# Customer Interview 101

- Artifact Type: Customer Interview
- Segment: Enterprise
- Region: NA
- Participants: Product Manager, Program Lead, Program Lead
- Source ID: CUSTOMER-INTERVIEWS-7101

## Summary
Most comments focused on training cadence and workshop scheduling details. Several attendees shared general appreciation for weekly product updates.
