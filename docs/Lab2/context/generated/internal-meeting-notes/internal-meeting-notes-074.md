# Internal Meeting Note 074

- Artifact Type: Internal Meeting Note
- Segment: EMEA Enterprise
- Region: NA
- Participants: Customer Success Lead, Customer Success Lead, PM
- Source ID: INTERNAL-MEETING-NOTES-7074

## Summary
Stakeholders liked the visual roadmap and asked for more examples in docs. Participants requested more webinars and certification tracks for admins.
